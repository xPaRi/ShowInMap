...
namespace IDEA.Library
{
    ...
    public class Transformation
    {
        ...
        /* Tato funkce pracuje správně jen pro zónu N a 'nějak' nepočítá s dalšími. Dále obsahuje
           také části a proměnné, které jsou počítány, ale nejsou nikde využity. Mám pocit, že funkce není
           dokončená a tak jsem ji radši deaktivoval.
           
        public static WGS84Coordinate TransformWGS84(UTMCoordinate utmCoordinate)
        {
            var elipsoid = Elipsoid.GetDefault();
            var eccSquared = elipsoid.EccSquared;
            var a = elipsoid.A;

            double UTMEasting = utmCoordinate.UTMEasting;
            double UTMNorthing = utmCoordinate.UTMNorthing;
            int UTMZoneNumber = utmCoordinate.ZoneNumber;
            string UTMZoneLetter = utmCoordinate.ZoneLetter;
            ...
            return new WGS84Coordinate(Lat, Long);
        }
        */
